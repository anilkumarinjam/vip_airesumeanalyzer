...
def extract_name(nlp_text, matcher):
    ...
    '''
    # Adjusting pattern to be a list of dictionaries for spacy matcher
    pattern = [[{"POS": "PROPN"}, {"POS": "PROPN"}]]  # Assuming `cs.NAME_PATTERN` is similar to this structure
    
    # Adding pattern to matcher with the correct syntax
